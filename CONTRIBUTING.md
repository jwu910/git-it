...
2. Naming conventions:
   ...
   - Branch names should follow the PROJECT-ISSUE convention with an optional short description. e.g. `GS-123-contributing-guidelines`
   - Commit messages should follow the Commitizen [guidelines](https://github.com/angular/angular.js/blob/master/DEVELOPERS.md#-git-commit-guidelines) also known as conventional-changelog. Use `npm run commit` to start the commit dialogue.
